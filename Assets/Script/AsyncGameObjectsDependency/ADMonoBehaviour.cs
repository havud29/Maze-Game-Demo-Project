...
namespace AsyncGameObjectsDependency.Core
{
    ...
    public class ADMonoBehaviour : MonoBehaviour
    {
        ...
        private bool ComputeIsUpdateReady =>
            _FilledAllDependencies && !IsDestroyingBehaviour && !_Unloaded && _IsBehaviourEnabled;
        ...
        [NonSerialized] private bool _Unloaded = false;
        ...
        protected void OnDestroy()
        {
            ...
            if (_DiContainer != null && !this.Unloaded)
            {
